...
public class SeleccionRuleta implements Seleccion{
	...
	public void selecciona(Cromosoma[] poblacion, double prob_cruce) {
		...
		for (int i = 0; i < individuos; i++){
			...
			/*nuevaPoblacion[i].setAptitud(poblacion[seleccionados[i]].getAptitud());
			nuevaPoblacion[i].setAptDesp(poblacion[seleccionados[i]].getAptDesp());
			nuevaPoblacion[i].setPunt_acum(poblacion[seleccionados[i]].getPunt_acum());
			nuevaPoblacion[i].setPuntuacion(poblacion[seleccionados[i]].getPuntuacion());*/
		}
